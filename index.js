...
async function startWuha() {
    ...
    sock.ev.on('connection.update', (update) => {
        ...
        if (qr) {
            // Generate a clean, clickable image link for the QR Code
            const qrImageUrl = `https://api.qrserver.com/v1/create-qr-code/?size=400x400&data=${encodeURIComponent(qr)}`;
            console.log('\n======================================================');
            console.log('🌟 CLICK THE LINK BELOW TO SEE YOUR QR CODE 🌟');
...
// Render 60-second timeout fix: Fake a web server
